...
const styles = StyleSheet.create({
  eyebrow: { color: colors.primary, fontSize: 11, letterSpacing: 1.2, fontWeight: "800", marginTop: 6 }, heading: { color: colors.ink, fontWeight: "800", letterSpacing: -0.6, marginTop: 4 }, summary: { color: colors.muted, marginTop: 4, marginBottom: 20 }, input: { backgroundColor: colors.surface, marginTop: 16 }, sound: { backgroundColor: colors.surface, borderColor: colors.line, borderWidth: 1, borderRadius: 16, padding: 13, marginTop: 12 }, soundTitle: { color: colors.ink, fontWeight: "700" }, soundCopy: { color: colors.muted, fontSize: 12, marginTop: 2 }, sync: { backgroundColor: colors.warningSoft, borderRadius: 14, padding: 12, marginBottom: 12 }, syncText: { color: colors.warning, lineHeight: 19 }, activeTask: { backgroundColor: colors.primarySoft, borderColor: "#C9E3D6", borderWidth: 1, borderRadius: 16, padding: 14, marginBottom: 2 }, activeTaskLabel: { color: colors.primary, fontSize: 10, fontWeight: "800", letterSpacing: 1 }, activeTaskTitle: { color: "#123D2D", fontWeight: "800", marginTop: 4 }, warning: { color: colors.warning, marginTop: 7, lineHeight: 18 }, empty: { backgroundColor: colors.surface, borderRadius: 18, padding: 17, borderWidth: 1, borderColor: colors.line, marginTop: 12 }, emptyTitle: { color: colors.ink, fontWeight: "700" }, emptyCopy: { color: colors.muted, marginVertical: 6, lineHeight: 19 }, endConfirm: { backgroundColor: colors.dangerSoft, borderWidth: 1, borderColor: "#F1C7C3", borderRadius: 18, padding: 16, marginTop: 12 }, endTitle: { color: "#7D2929", fontWeight: "800" }, endCopy: { color: "#7D2929", marginVertical: 7, lineHeight: 19 }, error: { backgroundColor: colors.dangerSoft, borderRadius: 14, padding: 12, marginTop: 12 }, errorText: { color: "#7D2929" }, finished: { backgroundColor: colors.primarySoft, borderRadius: 20, padding: 18, borderWidth: 1, borderColor: "#C9E3D6", marginTop: 14 }, finishedTitle: { color: "#123D2D", fontWeight: "800" }, finishedCopy: { color: "#456556", marginTop: 5, marginBottom: 16 }, finishedButton: { marginBottom: 9 },
});
