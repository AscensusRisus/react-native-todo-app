...
export default function FocusScreen() {
  ...
  return <AppScreen>
    ...
    <Text variant="headlineMedium" style={styles.heading}>Focus</Text><Button compact mode="text" icon={isDark ? "weather-sunny" : "weather-night"} onPress={() => void setMode(isDark ? "light" : "dark")}>{mode === "system" ? "Theme" : isDark ? "Light" : "Dark"}</Button>
